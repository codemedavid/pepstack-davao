...
const PeptideCalculator: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-pink-50 via-pink-100/40 to-rose-50 font-inter flex flex-col">
            <Header
            ...
            <main className="flex-grow container mx-auto px-4 py-8 md:py-12">
                <div className="max-w-3xl mx-auto">
                    ...
                    <a
                        href="/"
                        className="inline-flex items-center gap-2 text-gray-600 hover:text-pink-700 mb-6 group"
                    >
                    ...
                    <div className="text-center mb-10">
                        ...
                        <h1 className="text-3xl md:text-4xl font-bold text-pink-700 mb-4">Peptide Calculator</h1>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-start">
                        ...
                        <div className="bg-white rounded-2xl shadow-soft border border-pink-100 overflow-hidden">
                            <div className="bg-gradient-to-r from-pink-500 to-rose-500 px-6 py-4 border-b border-pink-400">
                            ...
                            <div className="p-6 md:p-8 space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <select
                                        ...
                                        className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:ring-1 focus:ring-pink-500 focus:border-pink-500 transition-all outline-none bg-white text-black appearance-none cursor-pointer"
                                ...
                                <div className="space-y-2">
                                    ...
                                    <div className="relative">
                                        <input
                                            ...
                                            className="w-full pl-4 pr-12 py-3 border border-gray-200 rounded-lg focus:ring-1 focus:ring-pink-500 focus:border-pink-500 transition-all outline-none text-black"
                                        />
                                    ...
                                    <div className="flex gap-2">
                                        <div className="relative flex-1">
                                            <input
                                                ...
                                                className="w-full pl-4 pr-16 py-3 border border-gray-200 rounded-lg focus:ring-1 focus:ring-pink-500 focus:border-pink-500 transition-all outline-none text-black"
                                            />
                                            <div className="absolute inset-y-0 right-0 flex items-center px-4 bg-gray-50 border-l border-gray-200 rounded-r-lg text-gray-500 text-sm font-medium">
                                                {selectedUnit}
                                            </div>
                                ...
                                <button
                                    onClick={handleReset}
                                    className="w-full py-2 text-sm text-gray-500 hover:text-pink-700 hover:bg-pink-50 rounded-lg transition-colors flex items-center justify-center gap-2"
                                >
                        ...
                        {/* Results Card */}
                        <div className={`bg-white rounded-2xl shadow-soft border border-pink-100 overflow-hidden transition-all duration-300 ${resultUnits !== null ? 'opacity-100 translate-y-0' : 'opacity-50 translate-y-4'}`}>
                            <div className="px-6 py-8 bg-gradient-to-r from-pink-500 via-pink-500 to-rose-500">
                                    ...
                                    <>
                                            ...
                                            <svg width="100%" height="140" viewBox="0 0 420 140" className="mx-auto" preserveAspectRatio="xMidYMid meet">
                                                <defs>
                                                    ...
                                                    <linearGradient id="fluidGradient" x1="0%" y1="0%" x2="100%" y2="0%">
                                                        ...
                                                        <stop offset="50%" style={{ stopColor: '#ec4899', stopOpacity: 0.95 }} />
                                                    ...
                                                    return (
                                                        <g key={i}>
                                                            <line
                                                                ...
                                                                stroke={isMajorTick ? "#be185d" : "#f472b6"}
                                                ...
                                                <text x="363" y="115" fontSize="12" fill="#be185d" textAnchor="end" fontWeight="700" fontFamily="system-ui, -apple-system, sans-serif">
                                        ...
                                        <div className="w-full bg-gray-50 rounded-xl p-4 border border-gray-100 space-y-3">
                                            ...
                                            <div className="flex justify-between items-center text-sm pt-2 border-t border-gray-200">
                                                ...
                                                <span className="font-bold text-pink-600">{resultMgPerUnit} mg</span>
                                            </div>
                    ...
                    <div className="mt-12 p-6 bg-pink-50 rounded-xl border border-pink-200 animate-fadeIn">
